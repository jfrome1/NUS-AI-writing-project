...
The objective of this course is for you to form your own first considered thoughts. We want you to relate to the text with your own unique life experiences. Please do not outsource your contemplations to a machine (or to any other humans for that matter).

That being said, we are not demonising the use of A.I. in your learning. We understand that A.I can be a useful tool to brainstorm ideas, check for grammar etc.

Please do uphold academic integrity when using A.I. in your written work. Submitting the output generated by an A.I. and passing it as your own idea without attribution is plagiarism. We take this very seriously. As such, if you were to use A.I. to help you with any part of the written work, please do the following:

State the A.I. tool used
[TBC the way to submit transcript]

You will not be penalised for the use of A.I. if duly attributed. The submitted work will be assessed based on the quality of ideas. We are looking for your voice in the submitted work and it is hard to get this from an A.I..
...
If you use GenAI but don't submit [:the links](#x-submit-all) and cite the tool as described in "Guidelines for GenAI use", you've [:broken the rules](#x-no-submission).
